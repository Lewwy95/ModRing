...
if exist "%~dp0..\reshade-shaders" rmdir /s /q "%~dp0..\reshade-shaders"
if exist "%~dp0..\reshade-presets" rmdir /s /q "%~dp0..\reshade-presets"
if exist "%~dp0..\ReShade.ini" del /s /q "%~dp0..\ReShade.ini"
if exist "%~dp0..\ReShade.log" del /s /q "%~dp0..\ReShade.log"
